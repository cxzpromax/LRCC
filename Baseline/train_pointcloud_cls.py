...
from data_utils.ModelNetDataLoader import ModelNetData_10_Loader
import argparse
import numpy as np
import os
import torch
...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str, default='/media/one/系统/chenzhuang/Datasets/modelnet40_normal_resampled/')
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):  # [0, 200]
        ...
        for batch_id, data in tqdm(enumerate(trainDataLoader, 0), total=len(trainDataLoader), smoothing=0.9):
            ...
            pred = classifier(points)  # batch_size;num_class(8*40)
